...
\item[p.\  51] The first sentence in Section 3.6 should say "Girls'" instead of "Girl's". 
...
\item[p.\  70] The source for Problem 4.44 should be USA December TST for IMO 2014.
...
\item[p.\  89] The last line before Example 5.15 should say "Girls'" instead of "Girl's".
